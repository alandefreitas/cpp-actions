...
- name: Install packages
  uses: alandefreitas/cpp-actions/package_install@master
  id: package-install
  with:
    vcpkg: fmt
    apt-get: g++-11
...
- name: Clone Boost.Variant2
  uses: alandefreitas/cpp-actions/boost_clone@master
  with:
...
- name: Test Boost.Variant2
  uses: alandefreitas/cpp-actions/b2_workflow@master
  with:
